...
% VELOCITY X
VELOCITY_Rx = plot(Vrx,TETA2,MVx_A,TETA2,MVx_B,TETA2,MVx_C,TETA2,MVx_D);
axis(Vrx,[0 6.5 -1.7 1.7]);
grid(Vrx,'on'); grid(Vrx,'minor');
xlabel(Vrx,'T (rad)'); ylabel(Vrx,'Vx (m/s)');
...
% VELOCITY Y
VELOCITY_Ry = plot(Vry,TETA2,MVy_A,TETA2,MVy_B,TETA2,MVy_C,TETA2,MVy_D);
axis(Vry,[0 6.5 -1.7 1.7]);
grid(Vry,'on'); grid(Vry,'minor');
xlabel(Vry,'T (rad)'); ylabel(Vry,'Vy (m/s)');
...
% OMEGA Z
OMEGA_Rz = plot(OMEGArz,TETA2,OMEGA_2,TETA2,OMEGA_3,TETA2,OMEGA_4,TETA2,OMEGA_5,TETA2,OMEGA_6);
%axis(OMEGArz,[0 6.5 -7 11]);
grid(OMEGArz,'on'); grid(OMEGArz,'minor');
xlabel(OMEGArz,'T (rad)'); ylabel(OMEGArz,'OMEGAz (rad/s)');
...
% ACCELERATION X
ACCELERATION_Rx = plot(Arx,TETA2,MAx_A,TETA2,MAx_B,TETA2,MAx_C,TETA2,MAx_D);
axis(Arx,[0 6.5 -17 21]);
grid(Arx,'on'); grid(Arx,'minor');
xlabel(Arx,'T (rad)'); ylabel(Arx,'Ax (m/s^2)');
...
% ACCELERATION Y
ACCELERATION_Ry = plot(Ary,TETA2,MAy_A,TETA2,MAy_B,TETA2,MAy_C,TETA2,MAy_D);
axis(Ary,[0 6.5 -19 17]);
grid(Ary,'on'); grid(Ary,'minor');
xlabel(Ary,'T (rad)'); ylabel(Ary,'Ay (m/s^2)');
...
% ALPHA Z
ALPHA_Rz = plot(ALPHArz,TETA2,ALPHA_2,TETA2,ALPHA_3,TETA2,ALPHA_4,TETA2,ALPHA_5,TETA2,ALPHA_6);
%axis(OMEGArz,[0 6.5 -75 70]);
